...
OWNER_ID = list(map(int, getenv("OWNER_ID", "5099049612").split()))
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/8f93b1dfa82a487e41566.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://telegra.ph/file/8f93b1dfa82a487e41566.jpg")
...
if PING_IMG_URL:
    if PING_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://telegra.ph/file/8f93b1dfa82a487e41566.jpg"

if START_IMG_URL:
    if START_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://telegra.ph/file/8f93b1dfa82a487e41566.jpg"
